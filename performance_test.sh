...
./bin/queue_tester_remove_performance -q 1 -a 100000000 #TEST WITH DIFFERENT INSERT METHODS
./bin/queue_tester_remove_performance -q 2 -a 100000000
./bin/queue_tester_remove_performance -q 4 -a 100000000
./bin/queue_tester_remove_performance -q 8 -a 100000000
./bin/queue_tester_remove_performance -q 16 -a 100000000
./bin/queue_tester_remove_performance -q 32 -a 100000000
./bin/queue_tester_remove_performance -q 64 -a 100000000

./bin/queue_tester_rand_computation -d 10 -q 2 -l false -p 2 -c 2 --local-balance-type=all
./bin/queue_tester_rand_computation -d 10 -q 2 -l false -p 2 -c 1 --local-balance-type=all
./bin/queue_tester_rand_computation -d 10 -q 4 -l false -p 4 -c 4 --local-balance-type=all
./bin/queue_tester_rand_computation -d 10 -q 4 -l false -p 4 -c 2 --local-balance-type=all
./bin/queue_tester_rand_computation -d 10 -q 4 -l false -p 4 -c 1 --local-balance-type=all
./bin/queue_tester_rand_computation -d 10 -q 8 -l false -p 8 -c 8 --local-balance-type=all
./bin/queue_tester_rand_computation -d 10 -q 8 -l false -p 8 -c 4 --local-balance-type=all
./bin/queue_tester_rand_computation -d 10 -q 8 -l false -p 8 -c 1 --local-balance-type=all
./bin/queue_tester_rand_computation -d 10 -q 16 -l false -p 16 -c 16 --local-balance-type=all
./bin/queue_tester_rand_computation -d 10 -q 16 -l false -p 16 -c 8 --local-balance-type=all
./bin/queue_tester_rand_computation -d 10 -q 16 -l false -p 16 -c 1 --local-balance-type=all